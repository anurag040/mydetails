from app.api.endpoints import upload, statistics, analysis, chat, clustering, talk_to_data, analysis_matrix
...
app.include_router(analysis_matrix.router, prefix="/api/v1", tags=["AnalysisMatrix"])
